...
const NotFoundPage = async () => {
  ...
  return (
    <div className="w-full h-full flex items-center justify-center">
      <FaInfinity className="w-48 h-40 text-[--color-diminish]" />

      <Path />

      <div className="mt-4 flex flex-col items-center">
        <h3 className="text-[--color-diminish]">
          Here&apos;s a random fact to compensate for the awkwardness:
        </h3>
        <span className="block text-center text-sm mt-2 max-w-[80%] leading-4 text-[--color-text-primary]">
          {text}
        </span>
      </div>
    </div>

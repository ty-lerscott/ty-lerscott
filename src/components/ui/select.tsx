...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center font-semibold justify-between border border-[--color-darker] text-[--color-medium-light] text-xs p-4 ring-offset-white placeholder:text-[--color-medium-light] text-left focus:outline-none focus:ring-2 focus:ring-[--color-medium] focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className,
    )}
    {...props}
  >
